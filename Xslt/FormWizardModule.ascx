...
<asp:UpdatePanel ID="pnlFormWizard" runat="server">
	<ContentTemplate>
		<asp:Panel ID="pnlForm" CssClass="wrap-form" DefaultButton="btnSubmit" runat="server">
			...
			<div class="formwizard-bottom">
				<div class="form-group frm-captcha" id="divCaptcha" runat="server">
					<telerik:RadCaptcha ID="captcha" runat="server" ValidationGroup="formwizard"
						EnableRefreshImage="true" ValidatedTextBoxID="txtCaptcha" CaptchaImage-RenderImageOnly="true"
						Width="50%" CaptchaTextBoxLabel=""
				...
				<div class="form-group frm-btnwrap">
					...
					<div class="frm-btn">
						...
						<asp:Button CssClass="btn btn-default frm-btn-submit" ID="btnSubmit" runat="server"
							ValidationGroup="formwizard" />
